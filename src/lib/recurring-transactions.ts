...
export type RecurringRule = { id: string; type: 'income' | 'expense'; wallet_id: string; category_id: string; amount: number; note: string | null; frequency: 'weekly' | 'monthly'; start_date: string; end_date: string | null; next_due_at: string; active: boolean; archived_at: string | null; wallet: { name: string; currency: string } | null; category: { name: string } | null; };
