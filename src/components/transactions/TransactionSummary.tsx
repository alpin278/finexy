  ...
  return (
    <section aria-label={`Transaction summary in ${reportingCurrency}`} className="space-y-3">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <span className="rounded-full border border-border bg-card px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-secondary">Reporting currency · {reportingCurrency}</span>
      </div>
