...
export function WalletAccountCard({ wallet, menuOpen, onToggleMenu, onView, onEdit, onSetLimit, onDelete }: WalletAccountCardProps) {
  ...
  return <Card padding="md" hoverable className="relative min-w-0 flex flex-col gap-5">
    ...
    <div><p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-secondary">Current balance</p><p className="money-value value-change mt-1 text-2xl font-bold tracking-tight text-primary">{formatWalletAmount(wallet.balance, wallet.currency)}</p></div>
