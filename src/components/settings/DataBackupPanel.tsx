  ...
  return <div className="space-y-4">
    <div className="grid gap-3 sm:grid-cols-2">
      <div className="rounded-2xl border border-border bg-surface p-4">
        <div className="flex items-start gap-3"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-border/60 bg-card text-primary"><Icon name="download" className="text-lg" /></div><div><p className="text-sm font-semibold text-primary">Export full backup</p><p className="mt-1 text-xs leading-relaxed text-secondary">Download your profile, preferences, wallets, categories, ledger, transfers, budgets, and recurring rules as versioned JSON.</p></div></div>
      ...
      <div className="rounded-2xl border border-border bg-surface p-4">
        <div className="flex items-start gap-3"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-border/60 bg-card text-primary"><Icon name="upload" className="text-lg" /></div><div><p className="text-sm font-semibold text-primary">Import backup</p><p className="mt-1 text-xs leading-relaxed text-secondary">Only Finexy JSON backups are accepted. The file is parsed and validated before anything can be written.</p></div></div>
        ...
        <div className="mt-4 flex min-w-0 items-center gap-2 rounded-xl border border-dashed border-border bg-card p-2">
