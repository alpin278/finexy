    ...
    <div className="space-y-6 pb-8 animate-in fade-in-50 duration-200">
      ...
      <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1fr)_280px]">
        <div className="min-w-0 space-y-6">
          <SettingsSection icon="person" eyebrow="Account" title="Profile & Identity" description="Make your workspace feel like yours. Your display name and location are saved to your Finexy profile. Email remains managed by Supabase Auth.">
          ...
          <SettingsSection icon="currency-dollar" eyebrow="Regional defaults" title="Currency & Regional" description="Choose the formats that make your balances and transactions easiest to read.">
          ...
          <SettingsSection icon="receipt" eyebrow="Money habits" title="Transaction Preferences" description="Set a few defaults that keep everyday personal finance tracking quick and consistent.">
            <div className="grid gap-4 sm:grid-cols-2">
...
{telegramError && <div role="alert" className="mt-4 rounded-xl border border-danger/25 bg-danger/10 px-3.5 py-3 text-xs font-medium text-danger">{telegramError}</div>}
          ...
          <SettingsSection icon="shield-check" eyebrow="Account safety" title="Security & 2FA" description="Review the future security surface without storing passwords, secrets, or real authentication state.">
